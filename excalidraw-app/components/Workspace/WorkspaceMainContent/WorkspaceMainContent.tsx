...
import type { DrawingDefaults } from "../../../drawingDefaults";
  ...
  const renderContent = () => {
    switch (dashboardView) {
      ...
      case "preferences":
        return (
          <PreferencesPage
            theme={theme}
            setTheme={setTheme}
            onDrawingDefaultsChange={onDrawingDefaultsChange}
          />
        );
      case "workspace":
        return (
      ...
      case "teams-collections":
        return (
          <TeamsCollectionsPage workspaceId={workspace?.id} isAdmin={isAdmin} />
        );
      case "notifications":
